...
| `LOG_FILE` | `~/Desktop/Claude Code/tasks/active/plan-review-log_<yyyy-mm-dd>-<slug>.md` | Append-only transcript of the argument (every round's critique + what changed). The artifact. |
